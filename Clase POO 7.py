...
#Pero con (VElectrico, Vehiculos) arroja un error porque se da preferencia
# a la primera clase que se indica, entonces aqui se hereda el constructor de
# VElectricos que no contiene argumento
